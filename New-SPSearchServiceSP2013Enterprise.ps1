...
# Settings 
$IndexLocation = Read-Host -Prompt "Enter search index location" 
$SearchAppPoolName = "SharePoint - Search Admin Web Service"
$SearchAppPoolAccountName = Read-Host -Prompt "Seach App Pool Account (DOMAIN\Username)"
$SearchServerName = (Get-ChildItem env:computername).value 
$SearchServiceName = "Search Service Application" 
$SearchServiceProxyName = $SearchServiceName + " Proxy" 
$DatabaseName = Read-Host -Prompt "Database name prefix"
